...
#define CONFIGURABLE_KEY_RTC_VIDEO_OLD_RENDER_TIMESTAMP_GAP   "rtc.video.old_render_timestamp_gap"
...
#define INTERNAL_KEY_RTC_LOW_LEVEL_TRIGGER                    "rtc.local_ap_low_level"
